<template>
  <div>
      ...
      <el-table :data="rolesList" border stripe>
        ...
        <el-table-column label="操作" width="300px">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" icon="el-icon-edit" @click="expandEditDialog(scope.row.id)">编辑</el-button>
            <el-button size="mini" type="danger" icon="el-icon-delete" @click="removeRoleByRoleId(scope.row.id)">删除</el-button>
    ...
    <!-- 修改角色对话框 -->
    <el-dialog title="修改角色" :visible.sync="editRolesDialogVisible" width="50%" @close="cancelResetDialog">
...
export default {
  ...
  methods: {
    ...
    async removeRoleByRoleId(id) {
        const confirmResult = await this.$confirm('将永久删除该用户，是否继续操作？',
        '温馨提示',
        {
